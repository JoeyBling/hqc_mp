...
<script src="${base}/statics/js/octopus/service/scenerySpot.js"></script>
</head>
<body>
	<div class="place">
    <span>位置：</span>
    <ul class="placeul">
        ...
        <li><a href="javascript:void(0);">景点管理</a></li>
    </ul>
    </div>
    <div class="rightinfo">
    <div id="rightbody">
      ...
      <div id="add" style="display:none">
            <form id="sceneryForm" method="post" class="form-horizontal">
				<input type="hidden" name="id" id="id" />
				<div class="form-group">
				   	<div class="col-sm-2 control-label">景点名称</div>
				   	<div class="col-sm-3">
				      <input type="text" id = "sceneryNames" name="sceneryName" class="form-control" placeholder="景点名称" onblur="verify()"/>
				    </div>
				</div>
																				
				<div class="form-group">
				   	<div class="col-sm-2 control-label">所属景区</div>
				   	<div class="col-sm-3">
				        <select  name="scenicId" class="form-control" >
							<option  value="">所属景区</option>
						</select>
				...
				<div class="form-group">
				   	<div class="col-sm-2 control-label">景点缩略图上传</div>
				   	<div class="col-sm-3">				      
				...
				<div class="form-group">
				   	<div class="col-sm-2 control-label">景点简介</div>
				   	<div class="col-sm-3">
				      <textarea rows="5" cols="5" id = "about" name="about" class="form-control" placeholder="景点简介"/></textarea>
				    </div>
				</div>
				
				<div class="form-group">
				   	<div class="col-sm-2 control-label">景点详细介绍</div>
				   	<div class="col-sm-6">
				      	<div id="sceneryContent" name="sceneryContent"></div>
				    </div>
				</div>
    ...
    function sendFile(file) {
        ...
        $.ajax({
            ...
            success: function (result) {
                $("#sceneryContent").summernote('insertImage', "${base}/" + result.filePath.replace(/\\/g, "/"), 'img'); // the insertImage API 
            }
        });
    }
</script>
