...
$(function() {
			recentNews(topRequest.QueryString("page")); // 获取所有最新动态
		});
...
function init() {
	...
	$('#content').dropload({
		...
		domUp : {
			...
			domRefresh : '<div class="dropload-refresh">↓下拉刷新-最新动态</div>',
			domUpdate : '<div class="dropload-update">↑释放更新-最新动态</div>',
			domLoad : '<div class="dropload-load"><span class="loading"></span>加载中-最新动态...</div>'
		},
		domDown : {
			domClass : 'dropload-down',
			domRefresh : '<div class="dropload-refresh">↑上拉加载更多-最新动态</div>',
			domLoad : '<div class="dropload-load"><span class="loading"></span>加载中-最新动态...</div>',
			domNoData : '<div class="dropload-noData">暂无数据-最新动态</div>'
		},
