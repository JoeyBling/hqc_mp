    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function finishMobileDate(e) {
                ...
                //积分兑换专属操作
                if(_self.trigger.id == "openDate"){
                	$("#tempDate").val((date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd);
                	var htmlText = "当前已选日期"+(date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
                	$("#checkDate").html(htmlText);
                }else{
