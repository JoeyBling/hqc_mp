...
public class SysFileController {
	...
	public R upload(@RequestParam("name") String flag, Integer uploadType,
	...
	private String getTrueFileName(String file_Name, Integer uploadType) {
		...
		} else if (uploadType == UploadType.scenicSpotThumb.getValue()) {
			bf.append("scenicSpotThumb" + File.separator);
		} else if (uploadType == UploadType.articleImg.getValue()) {
			bf.append("articleImg" + File.separator);
		} else if (uploadType == UploadType.goodsThumb.getValue()) {
			bf.append("goodsThumb" + File.separator);
		} else if (uploadType == UploadType.articleThumb.getValue()) {
			bf.append("articleThumb" + File.separator);
		} else if (uploadType == UploadType.LevelIcon.getValue()) {
			bf.append("LevelIcon" + File.separator);
		} else if (uploadType == UploadType.ticketThumb.getValue()) {
			bf.append("TicketThumb" + File.separator);
		} else if (uploadType == UploadType.bannerThumb.getValue()) {
			bf.append("bannerThumb" + File.separator);
		} else if (uploadType == UploadType.ticketThumb.getValue()) {
			bf.append("cashThumb" + File.separator);
		} else if (uploadType == UploadType.other.getValue()) {
		} else {
		}
		return bf
				.append(DateUtils.format(new Date(),
						Constant.uploadSavePathFormat)
						+ File.separator
	...
	public void download(@RequestParam("name") String fileName, Boolean real,
