...
public class WxPayController implements WxPayService {
	...
	public WxPayOrderQueryResult queryOrder(
	...
	public WxPayOrderCloseResult closeOrder(@PathVariable String outTradeNo) {
		try {
			WxPayOrderCloseResult orderCloseResult = this.wxService
	...
	/**
	 * 统一下单(详见http://com.github.binarywang.wechat.pay.bean.pay.weixin.qq.com/
	 * wiki/doc/api/jsapi.php?chapter=9_1) 在发起微信支付前，需要调用统一下单接口，获取"预支付交易会话标识"
	 ...
	 * 详见http://mp.weixin.qq.com/wiki?t=resource/res_main
	 * &id=mp1421141115&token=&lang=zh_CN
	 * 
	 * @param request
	 *            请求对象，注意一些参数如appid、mchid等不用设置，方法内会自动从配置对象中获取到（前提是对应配置中已经设置）
	 */
	...
	public WxPayRefundQueryResult refundQuery(
			...
			throws WxErrorException {
		return this.wxService.refundQuery(transactionId, outTradeNo,
				outRefundNo, refundId);
	}

	/**
	 * 读取支付结果通知
	 * 详见http://com.github.binarywang.wechat.pay.bean.pay.weixin.qq.com/
	 * wiki/doc/api/jsapi.php?chapter=9_7
	 * 
	 * @param xmlData
	 */
	@Override
	@RequestMapping("/getOrderNotifyResult")
	public WxPayOrderNotifyResult getOrderNotifyResult(
			@RequestBody String xmlData) throws WxErrorException {
	...
	public WxPaySendRedpackResult sendRedpack(
			@RequestBody WxPaySendRedpackRequest request)
			throws WxErrorException {
	...
	public WxPayRedpackQueryResult queryRedpack(@PathVariable String mchBillNo)
			throws WxErrorException {
	...
	public WxEntPayResult entPay(@RequestBody WxEntPayRequest request)
			throws WxErrorException {
	...
	public WxEntPayQueryResult queryEntPay(@PathVariable String partnerTradeNo)
			throws WxErrorException {
	 ...
	 */
	@Override
	public byte[] createScanPayQrcodeMode1(String productId, File logoFile,
			Integer sideLength) {
		return this.wxService.createScanPayQrcodeMode1(productId, logoFile,
				sideLength);
	}
	 ...
	 */
	@Override
	public byte[] createScanPayQrcodeMode2(String codeUrl, File logoFile,
			Integer sideLength) {
		return this.wxService.createScanPayQrcodeMode2(codeUrl, logoFile,
				sideLength);
	}
	...
	public void report(@RequestBody WxPayReportRequest request)
			throws WxErrorException {
	...
	public File downloadBill(@RequestParam String billDate,
			@RequestParam String billType, @RequestParam String tarType,
			@RequestParam String deviceInfo) throws WxErrorException {
		return this.wxService.downloadBill(billDate, billType, tarType,
				deviceInfo);
	}
	...
	public WxPayMicropayResult micropay(
			@RequestBody WxPayMicropayRequest request) throws WxErrorException {
	...
	public WxPayOrderReverseResult reverseOrder(
			@RequestBody WxPayOrderReverseRequest request)
			throws WxErrorException {
		return this.wxService.reverseOrder(request);
	}

	@Override
	public String shorturl(WxPayShorturlRequest wxPayShorturlRequest)
			throws WxErrorException {
		// TODO 待补充完善
		return null;
	}
	...
	@Override
	public String authcode2Openid(
			WxPayAuthcode2OpenidRequest wxPayAuthcode2OpenidRequest)
			throws WxErrorException {
		// TODO 待补充完善
		return null;
	}
